document.addEventListener('DOMContentLoaded', () => {
  ...
  document.getElementById('calculate-btn').addEventListener('click', () => {
    ...
    if (!mortgageType) {
      ...
      document.querySelectorAll('.radio-inputs').forEach(el => el.classList.add('error'));
    } else {
      document.getElementById('type-alert').style.display = 'none';
      document.querySelectorAll('.radio-inputs').forEach(el => el.classList.remove('error'));
    }
  ...
  document.getElementById('clear-btn').addEventListener('click', () => {
    ...
    defaultText.classList.remove('hide');
    calculationsContainer.classList.remove('show');
    document.querySelectorAll('.form-flex').forEach(div => div.classList.remove('error'));
